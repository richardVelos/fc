...
//								$('<a href="#" class="selecteee">aaa</a>'),
								...
								$('<div class="dp-nav-prev"></div>')
									.append(
										$('<a class="dp-nav-prev-year" href="#" title="' + $.dpText.TEXT_PREV_YEAR + '"><img src="scripts/calendar/images/larrow2.png" width="20" height="20" ></a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a class="dp-nav-prev-month" href="#" title="' + $.dpText.TEXT_PREV_MONTH + '"><img src="scripts/calendar/images/larrow.png" width="20" height="20" ></a>')
											.bind(
												'click',
												function()
												{
								...
								$('<div class="dp-nav-next"></div>')
									.append(
										$('<a class="dp-nav-next-year" href="#" title="' + $.dpText.TEXT_NEXT_YEAR + '"><img src="scripts/calendar/images/rarrow2.png" width="20" height="20" ></a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a class="dp-nav-next-month" href="#" title="' + $.dpText.TEXT_NEXT_MONTH + '"><img src="scripts/calendar/images/rarrow.png" width="20" height="20" ></a>')
											.bind(
												'click',
												function()
												{
